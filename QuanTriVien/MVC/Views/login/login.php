    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if($user){
            ...
            if($user['id_quyen'] == 2){
                ...
                header('Location: /project/QuanTriVien/MVC/index.php');
            }else{
                echo "<script>alert('Hãy Đăng Nhập Với Quyền Quản Trị Để Có Thể Truy Cập');</script>";
            }
        }else{
            echo "<script>alert('Thông Tin Đăng Nhập Không Chính Xác! Try Again!');</script>";
        }
    }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Login Quản Trị Luxury</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Login Quản Trị Luxury</h1>
                                    </div>
